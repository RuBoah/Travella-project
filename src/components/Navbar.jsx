...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-4 md:px-10 py-4 shadow-md flex justify-between items-center bg-white">
      <a href="/" className="text-2xl font-bold text-[#00A8CC] cursor-pointer">
        Travella
      </a>
      ...
      <div className="flex items-center gap-4">
        <a
          href="/hostregister"
          className="hidden md:inline text-sm font-medium hover:underline text-gray-700"
        >
          Become a Host
        </a>
        ...
        {isLoggedIn ? (
          <div className="relative group cursor-pointer">
            ...
            <div className="absolute right-0 mt-2 bg-white shadow-md rounded-md p-2 w-40 hidden group-hover:block z-50">
              ...
              <a
                href="/logout"
                className="block py-1 px-2 text-red-500 hover:bg-gray-100"
              >
                Logout
              </a>
            </div>
